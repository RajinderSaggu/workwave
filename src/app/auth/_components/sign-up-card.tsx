    ...
    <div className="flex items-center justify-center min-h-screen ">
      <Card className="max-w-md w-full shadow-lg border rounded-lg bg-white text-gray-800">
        <CardHeader className="px-6 py-4 text-center">
          <CardTitle className="text-2xl font-bold text-gray-900">Sign up  to continue</CardTitle>
        ...
        <CardFooter className="flex flex-col text-center py-4 text-gray-600">
          ...
          <SocialButtons />
          <div className='py-2'>
          Already have an account? <p onClick={() => setState("signIn")} className="text-blue-500 hover:underline">Login</p>
          </div>
        </CardFooter>
      </Card>
    </div>
